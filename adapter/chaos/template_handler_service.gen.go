...
const TemplateName = "chaos"

// Instance is constructed by Mixer for the 'chaos' template.
...
// process data associated with the 'chaos' template.
//
...
type HandlerBuilder interface {
	...
	// SetChaosTypes is invoked by Mixer to pass the template-specific Type information for instances that an adapter
	// may receive at runtime. The type information describes the shape of the instance.
	SetChaosTypes(map[string]*Type /*Instance name -> Type*/)
}
...
// at configuration time via the method 'SetChaosTypes'.
// These Type associated with an instance describes the shape of the instance
type Handler interface {
	adapter.Handler

	// HandleChaos is called by Mixer at request time to deliver instances to
	// to an adapter.
	HandleChaos(context.Context, *Instance) (adapter.CheckResult, error)
}
